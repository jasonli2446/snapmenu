    ...
    <ThemedView style={[styles.container, { backgroundColor: Colors.light.primary }]}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.disclaimerContainer}>
          <ThemedText style={styles.disclaimerText} darkColor="rgba(255,255,255,0.6)" lightColor="rgba(255,255,255,0.6)">
            Disclaimer: Results are generated by AI and may not be fully accurate. 
            Please confirm dish details with restaurant staff before making decisions.
          </ThemedText>
        </View>
